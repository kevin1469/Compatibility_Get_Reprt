...
class MyFrame1 ( wx.Frame ):
  ...
  def __init__( self, parent ):
    ...
    self.daily_final_staticText = wx.StaticText( self.m_panel3, wx.ID_ANY, u"Daily/Final：", wx.DefaultPosition, wx.DefaultSize, 0 )
    self.daily_final_staticText.Wrap( -1 )
    fgSizer3.Add( self.daily_final_staticText, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
    
    daily_final_choice1Choices = [ u"Daily Report", u"Final Report", u"Approval" ]
    self.daily_final_choice = wx.Choice( self.m_panel3, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, daily_final_choice1Choices, 0 )
    self.daily_final_choice.SetSelection( 0 )
    fgSizer3.Add( self.daily_final_choice, 1, wx.ALL|wx.EXPAND, 5 )
    
    self.testing_staticText = wx.StaticText( self.m_panel3, wx.ID_ANY, u"Testing List：", wx.DefaultPosition, wx.DefaultSize, 0 )
    self.testing_staticText.Wrap( -1 )
    fgSizer3.Add( self.testing_staticText, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
    
    self.testing_filePicker = wx.FilePickerCtrl( self.m_panel3, wx.ID_ANY, wx.EmptyString, u"Select a file", u"*.*", wx.DefaultPosition, wx.DefaultSize, wx.FLP_DEFAULT_STYLE )
    fgSizer3.Add( self.testing_filePicker, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL|wx.EXPAND, 5 )
    ...
    self.ps_textCtrl = wx.TextCtrl( self.m_panel3, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( -1,120 ), wx.HSCROLL|wx.TE_AUTO_URL|wx.TE_LEFT|wx.TE_MULTILINE|wx.TE_WORDWRAP )
    bSizer41.Add( self.ps_textCtrl, 0, wx.ALL|wx.EXPAND, 5 )
    ...
    bSizer25.AddSpacer( ( 120, 0), 1, wx.EXPAND, 5 )
    #self.testing_button = wx.Button( self.m_panel7, wx.ID_ANY, u"&Clear Button", wx.DefaultPosition, wx.DefaultSize, 0 )
    #bSizer25.Add( self.testing_button, 0, wx.ALL, 5 )
