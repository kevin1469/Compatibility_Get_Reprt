...
class MyFrame1 ( wx.Frame ):
  ...
  def __init__( self, parent ):
    ...
    self.get_button = wx.Button( self.m_panel3, wx.ID_ANY, u"&Get Report", wx.DefaultPosition, wx.DefaultSize, 0 )
    bSizer25.Add( self.get_button, 0, wx.ALL, 5 )
    self.get_button.Bind(wx.EVT_BUTTON, self.getbutton, self.get_button)
    
    self.update_button = wx.Button( self.m_panel3, wx.ID_ANY, u"&Update Issue", wx.DefaultPosition, wx.DefaultSize, 0 )
    bSizer25.Add( self.update_button, 0, wx.ALL, 5 )
    self.update_button.Bind(wx.EVT_BUTTON, self.updatebutton)
    
    self.clear_button = wx.Button( self.m_panel3, wx.ID_ANY, u"&Clear Data", wx.DefaultPosition, wx.DefaultSize, 0 )
    bSizer25.Add( self.clear_button, 0, wx.ALL, 5 )
    
    self.exit_button = wx.Button( self.m_panel3, wx.ID_ANY, u"&Exit", wx.DefaultPosition, wx.DefaultSize, 0 )
    ...
    self.m_staticline16 = wx.StaticLine( self.m_panel3, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LI_HORIZONTAL )
    bSizer23.Add( self.m_staticline16, 0, wx.EXPAND|wx.ALL, 5 )
    ...
    self.m_textCtrl17 = wx.TextCtrl( self.m_panel3, wx.ID_ANY, u"ONVIF Report:\\\dqa03\\QMD\\設計驗證部\\06_驗證六組\\01_ONVIF\\01_ONVIF_Report\\OBM\n\nGenetec Omnicast Report:\n\\\dqa03\\QMD\\設計驗證部\\06_驗證六組\\03_Genetec\\99_Genetec_Omnicast_Report_On_going\n\nGenetec Security Report:\n\\\dqa03\\QMD\\設計驗證部\\06_驗證六組\\03_Genetec\\02_Genetec_Securtity_Center\n", wx.DefaultPosition, wx.Size( -1,300 ), wx.HSCROLL|wx.TE_AUTO_URL|wx.TE_LEFT|wx.TE_MULTILINE|wx.TE_WORDWRAP )
    bSizer8.Add( self.m_textCtrl17, 1, wx.ALL|wx.EXPAND, 5 )
